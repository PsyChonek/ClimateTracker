 ...
 */
!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e(require("chart.js/helpers"), require("chart.js")) : "function" == typeof define && define.amd ? define(["chart.js/helpers", "chart.js"], e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).ChartDataLabels = e(t.Chart.helpers, t.Chart);
}(void 0, function (t, e) {
  "use strict";
  ...
  function u(t, e) {
    ...
    return e.clamp && (n = function (t, e) {
      for (var r, a, o, n = t.x0, i = t.y0, l = t.x1, u = t.y1, d = s(n, i, e), c = s(l, u, e); d | c && !(d & c);) {
        8 & (r = d || c) ? (a = n + (l - n) * (e.top - i) / (u - i), o = e.top) : 4 & r ? (a = n + (l - n) * (e.bottom - i) / (u - i), o = e.bottom) : 2 & r ? (o = i + (u - i) * (e.right - n) / (l - n), a = e.right) : 1 & r && (o = i + (u - i) * (e.left - n) / (l - n), a = e.left), r === d ? d = s(n = a, i = o, e) : c = s(l = a, u = o, e);
      }
  ...
  t.merge(_.prototype, {
    ...
    draw: function draw(t, e) {
      ...
      this.visible() && (a.save(), o.clip && (r = o.area, a.beginPath(), a.rect(r.left, r.top, r.right - r.left, r.bottom - r.top), a.clip()), a.globalAlpha = n(0, o.opacity, 1), a.translate(x(e.x), x(e.y)), a.rotate(o.rotation), v(a, i.frame, o), function (t, e, r, a) {
        ...
        }(r, n, s), t.font = s.string, t.textAlign = n, t.textBaseline = "middle", t.shadowBlur = a.textShadowBlur, t.shadowColor = a.textShadowColor, l && (t.fillStyle = i), h && (t.lineJoin = "round", t.lineWidth = c, t.strokeStyle = d), o = 0, u = e.length; o < u; ++o) {
          b(t, e[o], {
            stroked: h,
            filled: l,
            w: r.w,
  ...
  function w(t, e) {
    ...
    for (r = 0; r < t.length; ++r) {
      o = (a = t[r]).x - u.x, n = a.y - u.y, i = e.vx * o + e.vy * n, l = Math.min(l, i), s = Math.max(s, i);
    }
  ...
  var C = {
    ...
    update: function update(t) {
      ...
      for (e = 0, r = t.length; e < r; ++e) {
        o = (a = t[e]).model(), (n = a.$layout)._hidable = o && "auto" === o.display, n._visible = a.visible(), i |= n._hidable;
      }
    ...
    draw: function draw(t, e) {
      ...
      for (r = 0, a = e.length; r < a; ++r) {
        (n = (o = e[r]).$layout)._visible && (i = o.geometry(), l = $(o._el, o.model(), i), n._box.update(l, i, o.rotation()), o.draw(t, l));
      }
    }
  },
      P = "$default";
  ...
  return {
    ...
    defaults: {
      ...
      formatter: function formatter(e) {
        ...
        var r,
            ...
            o,
            n = e;
        if (t.isObject(e)) if (t.isNullOrUndef(e.label)) {
          if (t.isNullOrUndef(e.r)) for (n = "", o = 0, a = (r = Object.keys(e)).length; o < a; ++o) {
            n += (0 !== o ? ", " : "") + r[o] + ": " + e[r[o]];
          } else n = e.r;
        } else n = e.label;
        return "" + n;
    ...
    afterDatasetUpdate: function afterDatasetUpdate(e, r, a) {
      var o,
          n,
          i,
          l,
      ...
      for (g.save(), o = 0, i = p.length; o < i; ++o) {
        if ((d = p[o]).$datalabels = [], y && d && e.getDataVisibility(o) && !d.skip) for (n = 0, l = b.labels.length; n < l; ++n) {
          u = (s = b.labels[n])._key, (c = new _(s, g, d, o)).$groups = {
            _set: h,
            _key: u || P
          }, c.$context = {
            active: !1,
    ...
    afterEvent: function afterEvent(t) {
      var e,
          r,
          a,
          o,
      ...
      for (e = 0, r = h.length; e < r; ++e) {
        if ((n = h[e])[1]) for (a = 0, o = (s = n[0].element.$datalabels || []).length; a < o; ++a) {
